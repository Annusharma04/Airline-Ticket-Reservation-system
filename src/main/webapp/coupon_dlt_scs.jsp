    ...
    <div class="container d-flex align-items-center" id="nav-menu">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="active" href="coupon_delete.jsp">Delete Coupon</a></li>
        </ul>
                        ...
                        <div class="wow fadeInUp" data-wow-delay="0.2s">
                            <form method="post" action="dlt_coupon">
                                <div class="row g-3">
                                    ...
                                    <h3 class="mb-4 text-center">Delete Coupons<span class=" text-uppercase"> <small>By Coupon Id</small></span></h3>
