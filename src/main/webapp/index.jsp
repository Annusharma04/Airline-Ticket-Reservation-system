      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row" data-aos="zoom-in" data-aos-delay="100">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="member">
              <img src="assets/img/trainers/trainer-11.jpg" class="img-fluid" alt="">
              <div class="member-content">
                <h4>Odissa to Kerala</h4>
                <span>For Three Person</span>
                <span>INR 50,000</span>
                
                <ul>
                  <li>Complementay Food</li>
                  <li> 70 kg baggage allowed</li>
                </ul>
                <div class="social">
                  <a href="">Click</a>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="member">
              <img src="assets/img/trainers/trainer-21.jpg" class="img-fluid" alt="">
              <div class="member-content">
                <h4>Jaipur to Kerala</h4>
                <span>For One Person</span>
                <span>INR 40,000</span>
                
                <ul>
                  <li>Complementay Food</li>
                  <li> 60 kg baggage allowed</li>
                </ul>
                <div class="social">
                  <a href="">Click</a>
                </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="member">
              <img src="assets/img/trainers/trainer-31.jpg" class="img-fluid" alt="">
              <div class="member-content">
                <h4>Delhi to Goa</h4>
                <span>For Two People</span>
                <span>INR 20,000</span>
                
                  <ul>
                    <li>Complementay Food</li>
                    <li> 30 kg baggage allowed</li>
                  </ul>  
