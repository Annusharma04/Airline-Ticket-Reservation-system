...
<!-- ======= Header ======= -->
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center" id="nav-menu">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a href="coupon_add.jsp">Add Coupon</a></li>          
           <li><a class="active" href="coupon_search.jsp">Search Coupon</a></li>
     ...
     <!-- Page Header Start -->
        <div class="container-fluid page-header mb-3 p-0 custom-page-header" style="   background:linear-gradient(rgba(0, 0, 0, 0.436),rgba(0, 0, 0, 0.09)),url(assets/img/aeroplane1.jpg) top center;">         
        ...
        <div class="container-xxl py-3 portal-text">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s" data-aos="zoom-in" data-aos-delay="100">
                ...
                <h1 class="mb-0">Showing Results <span class=" text-uppercase">For the Coupon</span></h1>
            </div>
        </div>
