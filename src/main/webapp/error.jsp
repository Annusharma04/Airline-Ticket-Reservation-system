...
<!-- ======= Header ======= -->
  <header id="header" class="fixed-top">
    ...
    <a href="adminlogin.jsp" class="get-started-btn"> Admin Panel<i class="fa fa-arrow-right ms-3"></i></a>
        ...
        <div class="container-xxl py-2  portal-text">
            <div class="container" data-aos="zoom-in" data-aos-delay="100">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s" style="margin-bottom: 12%;">
                    <h6 class="section-title text-center  text-uppercase">Error 404</h6>
                    <h1 class="mb-0">Sorry <span class=" text-uppercase">Something Went Wrong!!</span></h1>
                </div>
            </div>
        </div>
