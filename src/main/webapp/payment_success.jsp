...
<!-- ======= Header ======= -->
 ...
 <!-- Page Header Start -->
       <div class="container-fluid page-header mb-5 p-0 custom-page-header" style="   background:linear-gradient(rgba(0, 0, 0, 0.436),rgba(0, 0, 0, 0.09)),url(assets/img/aeroplane1.jpg) top center;">         
        ...
        <div class="container-xxl py-5 portal-text">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s" data-aos="fade-left" data-aos-delay="100">
                <h6 class="section-title text-center  text-uppercase">Payment Success</h6>
                <h1 class="mb-5">Payment <span class=" text-uppercase">Success</span></h1>
                <h1 class="mb-5"><a href="GeneratePDF"> ->Click Here To Download Your Invoice<- </a></h1>
                <h6 class="section-title text-center  text-uppercase">We are requesting you to download your Invoice as a Ticket Proof</h6>
            </div>
        </div>
