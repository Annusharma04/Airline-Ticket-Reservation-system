...
<!-- ======= Header ======= -->
  <header id="header" class="fixed-top">
   ...
   <!-- Page Header Start -->
        <div class="container-fluid page-header mb-4 p-0 custom-page-header" style="   background:linear-gradient(rgba(0, 0, 0, 0.436),rgba(0, 0, 0, 0.09)),url(assets/img/aeroplane1.jpg) top center;">         
        ...
        <div class="container-xxl py-3 Add-text">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s"  data-aos="zoom-in" data-aos-delay="100">
                ...
                <h1 class="mb-2">Flight Adding <span class=" text-uppercase">Failed</span></h1>
                <h6 class="section-title text-center  text-uppercase">May Be Same ID Or Missed Some Inputs</h6>
            </div>
        </div> 
